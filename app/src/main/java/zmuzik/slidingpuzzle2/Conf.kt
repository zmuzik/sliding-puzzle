...
object Conf {
    ...
    const val GRID_COLUMNS_PORTRAIT_HANDHELD = 2
    const val GRID_COLUMNS_LANDSCAPE_HANDHELD = 3
    const val GRID_COLUMNS_PORTRAIT_TABLET = 4
    const val GRID_COLUMNS_LANDSCAPE_TABLET = 6
}
